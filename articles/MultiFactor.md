...
#> + edges from 00d6873 (vertex names):
...
lg
#> IGRAPH 1dc89b8 UN-B 9 11 -- 
#> + attr: type (v/l), name (v/c)
#> + edges from 1dc89b8 (vertex names):
...
#> [21] pillar_1.11.1      rlang_1.3.0        cachem_1.1.0       xfun_0.59         
