...
#> + edges from d9af640 (vertex names):
...
lg
#> IGRAPH 4b7df71 UN-B 9 11 -- 
#> + attr: type (v/l), name (v/c)
#> + edges from 4b7df71 (vertex names):
...
#> [21] pillar_1.11.1      bslib_0.11.0       RColorBrewer_1.1-3 rlang_1.3.0       
